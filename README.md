...
| Story ID | Story Title                             | Task ID | Task Title                              | Description                                                                                                                           | Estimation (Hrs) | Assigned To     | Status |
|----------|------------------------------------------|---------|------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|------------------|------------------|--------|
| TS-54    | Almacenar preferencias de usuarios       | T13     | Store User Preferences (Endpoint Deployment) | Desarrollar un endpoint que permita almacenar y actualizar las preferencias del usuario, como idioma, notificaciones o tema visual. | 4.5              | Hector Rios       | Done   |
| TS-57    | Gestionar Datos de Perfil de Usuario     | T14     | Manage User Profile Data (Endpoint Deployment) | Crear el endpoint para consultar y modificar la información del perfil del usuario, incluyendo validaciones y seguridad de acceso. | 3.5              | Leonardo Prieto   | To-Do  |
| TS-31    | Enviar Alerta de Fallo de Máquina        | T15     | Logic for failure notifications (Endpoints Deployment) | Implementar la lógica y endpoints para detectar fallos en máquinas y generar notificaciones automáticas a los usuarios responsables. | 5                | Gabriel Gordon     | Done   |
| TS-67    | Gestionar Alertas y Notificaciones       | T16     | General alert system (Endpoints Deployment) | Diseñar el sistema de endpoints para registrar, actualizar y consultar alertas y notificaciones generales del sistema.               | 5                | Gabriel Gordon     | Done   |
| TS-33    | Almacenar Historial de Rendimiento     | T17     | Basis for reports and analysis (Endpoints Deployment) | Desarrollar un endpoint para registrar y almacenar datos históricos de rendimiento de máquinas, con el fin de habilitar análisis posteriores y reportes. | 3                | Hector Rios         | In-Process   |
| TS-63    | Gestionar Turnos de Trabajo            | T18     | Personnel organization. (Endpoints Deployment)        | Crear un endpoint que permita la asignación, modificación y consulta de turnos laborales del personal técnico, asegurando la organización eficiente.   | 3.5              | Leonardo Prieto     | To-Do        |
| TS-58    | Gestionar Inventario de Máquinas       | T19     | Basic asset management. (Endpoints Deployment)        | Implementar el endpoint para gestionar el inventario de máquinas, incluyendo su registro, edición, baja lógica y estado operativo.                      | 3.5              | Gabriel Gordon      | Done         |
| TS-38    | Implementar Autenticación de Usuario   | T20     | Prerequisite for almost all interactions.             | Desarrollar los endpoints de autenticación (login, logout, verificación de tokens) para permitir el acceso seguro al sistema.                          | 4                | Leonardo Prieto     | To-Do        |
| TS-30    | Recuperar Datos de Máquina                 | T21     | Essential for monitoring. (Endpoints Deployment) | Implementar un endpoint para obtener datos operativos de una máquina específica, facilitando su monitoreo y diagnóstico.                          | 3                | Alessandra Becerra   | Done         |
| TS-36    | Mostrar Estado de la Máquina en Tiempo Real| T22     | Core of real-time monitoring.             | Desarrollar la lógica necesaria para visualizar en tiempo real el estado funcional de la máquina, incluyendo indicadores como temperatura y uso. | 5                | Gabriel Gordon        | In-Progress  |
| TS-37    | Integrar Sensor de Temperatura             | T23     | Necessary for data collection.            | Conectar e integrar el sensor de temperatura al sistema, asegurando la correcta lectura, transmisión y almacenamiento de los datos capturados.    | 3.5              | Alessandra Becerra   | In-Progress  |
| TS-68    | Procesar Datos de Sensores                 | T24     | Information processing for monitoring.    | Crear la lógica que permita procesar y filtrar los datos provenientes de sensores, transformándolos en información útil para monitoreo y análisis.| 4                | Gabriel Gordon        | In-Progress  |
| TS-70    | Generar Métricas de Rendimiento            | T25     | Visualizing metrics for dashboards.                      | Desarrollar la lógica que transforme los datos procesados en métricas claras y relevantes para su visualización en dashboards operativos.        | 4                | Leandro Contreras     | Done   |
| TS-71    | Implementar Agregación de Datos            | T26     | Processing volumes of data.                              | Implementar la funcionalidad que permita agrupar grandes volúmenes de datos por períodos o categorías para facilitar el análisis posterior.      | 4.5              | Alessandra Becerra    | Done   |
| TS-74    | Implementar Creación de Tareas de Máquina  | T27     | Essential for recording new activities on the machines   | Diseñar el endpoint que permita registrar nuevas tareas en las máquinas, incluyendo tipo de tarea, fecha y parámetros asociados.                  | 3                | Leandro Contreras     | Done   |
| TS-75    | Desarrollar Lógica para Asignación de Tareas a Máquinas  | T28     | Crucial for linking tasks to specific assets             | Implementar la lógica que permita asignar automáticamente o manualmente tareas a máquinas específicas, considerando disponibilidad y prioridad.      | 3                | Leandro Contreras   | Done   |
| TS-76    | Implementar Modificación de Tareas Existentes             | T29     | Essential for task planning adaptability                 | Desarrollar la funcionalidad que permita modificar tareas ya registradas, ajustando atributos como fecha, duración, responsable o descripción.       | 3                | Leandro Contreras   | Done   |
