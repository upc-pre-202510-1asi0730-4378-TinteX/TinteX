...
| **Campo**    | **Detalle**     | **Foto** |
|--------------|-----------------|-----------|
| Información completa  | Mi nombre es Héctor Javier Ríos Pacheco, tengo 19 años. Actualmente estoy cursando el 4to ciclo de la carrera de Ingeniería de Software en la UPC. Tengo conocimientos intermedios de C++, conocimiento básico de Java, portugués intermedio, inglés intermedio. Poseo como habilidades blandas la responsabilidad, compromiso, comunicación asertiva, tolerancia, manejo de tiempos y organización. Mi objetivo en este proyecto es aportar en la construcción sólida del mismo, así como verificar el avance correcto y dirección. Asimismo colaborar de manera correcta con los integrantes de grupo. |     <img src="./assets/foto1.png" alt="foto1" width="500">      |
