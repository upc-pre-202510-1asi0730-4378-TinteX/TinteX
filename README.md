...
| US41 | Mostrar hero con mensaje claro | Como visitante quiero ver un encabezado hero con título y subtítulo claros para comprender rápidamente el propósito de TinteX. | **Given** que visito la landing page<br>**When** la página se carga<br>**Then** veo un título (“TinteX”) y subtítulo explicativo debajo. | 09 |
| US42 | Sección de características principales | Como visitante quiero conocer las 3 funcionalidades clave de TinteX para decidir si me interesa la plataforma. | **Given** que estoy en la sección de features<br>**When** la sección está visible<br>**Then** veo tres íconos con título y breve descripción cada uno. | 09 |
| US43 | Formulario de Contacto | Como posible usuario quiero un formulario sencillo para dejar mi email y recibir novedades, para estar informado del lanzamiento. | **Given** que estoy al final de la página<br>**When** ingreso mi email y hago clic en “Suscríbete”<br>**Then** veo un mensaje de confirmación (“¡Gracias por suscribirte!”). | 09 |
| US44 | Navegación fija | Como usuario quiero un menú de navegación fijo en el header para saltar a secciones (Features, Pricing, Contacto) para acceder rápido. | **Given** que hago scroll<br>**When** llego al punto donde el header quedaría oculto<br>**Then** el menú permanece siempre visible en la parte superior. | 09 |
| US45 | Diseño responsive | Como usuario en móvil quiero que la landing page se adapte correctamente a pantallas pequeñas para navegar sin zoom.   | **Given** que visito desde un dispositivo móvil<br>**When** reduzco el ancho de la ventana por debajo de 768px<br>**Then** el layout de columnas se convierte en una sola columna apilada. | 09 |
| US46 | Soporte de dos idiomas | Como usuario internacional quiero poder cambiar la interfaz entre español e inglés para usar la aplicación en mi idioma preferido.  | **Given** que visito la landing page<br>**When** hago clic en el selector de idioma y elijo “English” o “Español”<br>**Then** todos los textos de la página se muestran en el idioma seleccionado sin romper el diseño ni perder contenido. | 09 |
...
1. Archivos HTML, CSS y JS Asegurse que todos los archivos de la página web sean implementados en HTML, CSS y JS para un correcto funcionamiento de la página. En el caso de la imágenes, nos permitimos usar los distintos formatos existentes (jpg, png, webp, etc).
2. Publicación de archivos Debido al funcionamiento del servicio de Github Pages, todos los archivos correspondientes al funcionamiento de nuestra aplicación será subidos al repositorio compartido de Github para poder trabajar de manera simultanea entre los integrantes del grupo.
3. Pruebas de funcionamiento Con cada actualización e implementación del repositorio se harán pruebas que garanticen el correcto funcionamiento de la página, además la página también será probada por usuarios externos al grupo de trabajo para evitar opiniones influenciadas por la propiedad del proyecto.
